    ...
    <div className="min-h-screen bg-[#FAFAF6] flex items-center justify-center px-4">
      <div className="w-full max-w-[400px]">
        ...
        <div className="bg-white border border-[#EAE8E2] rounded-[24px] p-8">
          <h1 className="font-[family-name:var(--font-fraunces)] text-3xl font-normal text-[#1E3A1E] mb-1">Welcome back</h1>
          <p className="text-sm text-[#9A9590] mb-8">Sign in to access your saved activities.</p>
        ...
        <p className="text-center text-sm text-[#9A9590] mt-6">
          ...
          <Link href="/auth/signup" className="text-[#1E3A1E] font-medium hover:underline">Sign up</Link>
        </p>
      </div>
    </div>
  );
